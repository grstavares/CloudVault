...
/// ULID
struct ULID: Identifiable, Hashable {
    
    var id: String { return self.stringValue }
    ...
    static let encodedArray = encodingChars.map { String($0) }
    ...
    var stringValue: String { self.t + self.r }
